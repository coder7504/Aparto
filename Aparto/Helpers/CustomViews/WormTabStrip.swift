...
public struct WormTabStripStylePropertyies {
    ...
    var kHeightOfWormForBubble: CGFloat = 40
    
    var kHeightOfDivider: CGFloat = 2
    
    var kHeightOfTopScrollView: CGFloat = 45
    ...
    var spacingBetweenTabs: CGFloat = 5
    ...
    var tabItemDefaultFont: UIFont = UIFont(name: "ProximaNova-Semibold", size: 12)!//UIFont(name: "arial", size: 14)!
    var tabItemSelectedFont: UIFont = UIFont(name: "ProximaNova-Semibold", size: 12)!//UIFont(name: "arial", size: 16)!
    
    /*****
     colors
     ****/
    
    var tabItemDefaultColor: UIColor = UIColor.hovered//.white
    
    var tabItemSelectedColor: UIColor = .clear
    
    //color for worm
    var WormColor: UIColor = UIColor.main//UIColor(netHex: 0x1EAAF1)
    
    var topScrollViewBackgroundColor: UIColor = .clear//UIColor(netHex: 0x364756)
    
    var contentScrollViewBackgroundColor: UIColor = .clear//UIColor.gray
...
public class WormTabStrip: UIView,UIScrollViewDelegate {
    ...
    public let contentScrollView: UIScrollView = UIScrollView()
...
//    }
    ...
    ******************************************/
    ...
    private func setWidthAndHeightOfWormForDistance(distance: CGFloat){
        ...
        worm.layer.cornerRadius = 10//worm.frame.size.height/2
    }
    ...
    private func syncAppearanceOfVC(){
        ...
        for i in 0..<count{
            ...
            if i == currentTabIndex {
                ...
                let vc = (responder as? UIViewController)!
                guard let _ = delegate as? UIViewController else {return}
